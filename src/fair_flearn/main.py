...
# GLOBAL PARAMETERS
OPTIMIZERS = ['qffedavg']
DATASETS = [ 'synthetic', 'vehicle', 'fmnist']   # fmnist: fashion mnist used in the AFL paper
...
def main():
    ...
    # read data
    train_path = os.path.join('src/fair_flearn/data', options['dataset'], 'data', 'train')
    test_path = os.path.join('src/fair_flearn/data', options['dataset'], 'data', 'test')
