...
def args_parser():
    ...
    parser.add_argument("--fl_method", type=str, default="FedAvg", help="Name of federated learning method to use, \
                        options are FedAvg, FedBN, FedProx")
    ...
    parser.add_argument("--wandb_name", type=str, default = "steven_reweighting", help="wandb project name, please set according to the details of your experiment")
